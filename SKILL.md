---
name: design-nang-liveshow-greenfield-edu-vn
description: Design system extracted from NẮNG V (https://nang.liveshow.greenfield.edu.vn/). Use when building UI that should match this brand's visual identity.
triggers:
  - "NẮNG V"
  - "nang-liveshow-greenfield-edu-vn"
  - "design like NẮNG V"
  - "NẮNG V風"
source: https://nang.liveshow.greenfield.edu.vn/
extractedAt: 2026-06-26T08:41:45.452Z
